...
//     framerate: 13,
//     numFrames: 70,
//     images: ["assets/coral-spritesheet-1.png"],
//     frames: [
...
//        console.log("coral 2 bounds: " + coral2.getBounds());
    ...
    coralIntersect = new createjs.Bitmap("assets/coral-1.png");
        ...
        coralIntersect.width = (tankWidth/5);
        coralIntersect.height = (tankHeight/5);
        coralIntersect.setBounds(coralIntersect.x, coralIntersect.y, coralIntersect.width, coralIntersect.height);
