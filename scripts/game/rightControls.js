...
function createRightControls() {
  //light controls
  //food controls
  var rightControlMenu = new createjs.Container();
  ...
  var rightControls = new createjs.Shape();
      rightControls.graphics.beginFill("Navy").drawRect(rightControlMenu.x, rightControlMenu.y, rightControlMenu.width, rightControlMenu.height);
          //drawRect(x, y, w, h)
